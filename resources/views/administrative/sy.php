<?php
require_once __DIR__ . '/../../../app/controllers/administrative/SchoolYearController.php';
...
<body>
    ...
    <div class="modal fade" id="createSyModal" tabindex="-1" aria-labelledby="createSyModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="../../../app/controllers/administrative/SchoolYearController.php" method="POST">
                    <?= Csrf::field() ?>
            ...
            <?php foreach ($school_years as $sy): ?>
                <tr>
                  ...
                  <td>
                    ...
                    <form action="../../../app/controllers/administrative/SchoolYearController.php" method="POST" style="display:inline-block;">
                        <?= Csrf::field() ?>
    ...
    <script src="../../../public/js/administrative/sy.js"></script>
