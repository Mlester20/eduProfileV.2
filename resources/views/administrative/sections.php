<?php
require_once __DIR__ . '/../../../app/controllers/administrative/SectionsController.php';
...
<body>
                        ...
                        <?php foreach ($sections as $section): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="../../../app/controllers/administrative/SectionsController.php" method="post" style="display: inline;">
                                        <?= Csrf::field() ?>
    ...
    <script src="../../../public/js/administrative/sections.js"></script>
</body>
</html>
