<?php
require_once __DIR__ . '/../../../app/controllers/administrative/achievementprofilecontroller.php';
...
<body>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <form action="achievement-profile.php" method="get" class="d-flex align-items-center gap-2">
            <label for="filter_school_year_id" class="form-label mb-0">School Year</label>
            <select class="form-select" id="filter_school_year_id" name="school_year_id" onchange="this.form.submit()">
                <option value="">-- All School Years --</option>
                <?php foreach(($school_years ?? []) as $school_year): ?>
                    <option value="<?php echo htmlspecialchars($school_year['id']); ?>" <?php echo (isset($_GET['school_year_id']) && $_GET['school_year_id'] == $school_year['id']) ? 'selected' : ''; ?>>
    ...
    <div class="modal fade" id="addAchievementModal" tabindex="-1" aria-labelledby="addAchievementLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="../../../app/controllers/administrative/achievementprofilecontroller.php" method="post">
                    ...
                    <?php foreach($achievementProfiles as $index => $profile): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="../../../app/controllers/administrative/achievementprofilecontroller.php" method="post" class="d-inline">
  ...
  <script src="../../../public/js/administrative/achievement-profile.js"></script>
</body>
</html>
