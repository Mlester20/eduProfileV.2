<?php
require_once __DIR__ . '/../../../app/controllers/administrative/GradeLevelsController.php';
    ...
    <div class="modal fade" id="createGradeLevelModal" tabindex="-1" aria-labelledby="createGradeLevelLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="../../../app/controllers/administrative/GradeLevelsController.php" method="post">
                    <?= Csrf::field() ?>
                        ...
                        <?php foreach($grade_levels as $grade_level): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="../../../app/controllers/administrative/GradeLevelsController.php" method="post" style="display: inline;">
                                        <?= Csrf::field() ?>
...
<script src="../../../public/js/administrative/grade-level.js"></script>
</body>
</html>
