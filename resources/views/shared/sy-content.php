<?php
require_once __DIR__ . "/../../../app/controllers/{$role}/SchoolYearController.php";
...
<body>
    ...
    <div class="modal fade" id="createSyModal" tabindex="-1" aria-labelledby="createSyModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="../../../app/controllers/<?= htmlspecialchars($role) ?>/SchoolYearController.php" method="POST">
                    <?= Csrf::field() ?>
    ...
    <script src="../../../public/js/shared/sy.js"></script>
