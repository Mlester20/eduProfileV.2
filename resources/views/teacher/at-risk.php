<?php
require_once __DIR__ . '/../../../app/controllers/teacher/atriskcontroller.php';
...
<head>
  ...
  <title><?php require_once __DIR__ . '/../../../app/helpers/title.php'; ?> | At-Risk Students</title>
...
<body>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <?php if(empty($atRiskLearners)): ?>
                        <tr>
                            <td colspan="6" class="text-center text-muted">No students currently flagged for the selected filters.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
  ...
  <script>
    function generateInsight(button){
        ...
        fetch('../../../app/controllers/teacher/insightcontroller.php', {
            method: 'POST',
