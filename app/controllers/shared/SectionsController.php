        ...
        public function create($data){
            try{
                if($this->model->create($data)){
                    ...
                    header("Location: ../../../resources/views/{$this->role}/sections.php");
                    exit();
                }else{
