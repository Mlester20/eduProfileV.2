    ...
    class StudentDevelopmentalProfileModel extends Model{
        ...
        public function getPage($teacher_id, $limit, $offset, $student_id = null){
            try{
                ...
                $query .= " ORDER BY dp.id DESC LIMIT ? OFFSET ?";
                $stmt = $this->con->prepare($query);
                if($student_id !== null){
                ...
                error_log("Error fetching developmental records page: " . $e->getMessage());
                return [];
            }
        }
        ...
        public function countAll($teacher_id, $student_id = null){
            try{
                ...
                error_log("Error counting developmental records: " . $e->getMessage());
                return 0;
            }
        }
