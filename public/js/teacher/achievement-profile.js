...
function editAchievementProfile(id, student_id, school_year_id, school_year, title, category, level, date_received, awarding_body, description){
    ...
    document.getElementById('edit_school_year_display').value = school_year;
